...
inst_ripple_carry_adder_0 : ripple_carry_adder
...
gen_rca_component : for i in 1 to data_width-2 generate -- "0 to data_width - 2" because for 'n' inputs it uses 'n-1' RCAs of size 'n'
...
result(data_width-2+data_width downto data_width-2+1) <= ripple_carry_adder_s(data_width-2);
result(data_width-2+data_width+1) <= ripple_carry_adder_carryout(data_width-2); --carryout
gen_result : for i in 1 to data_width-2 generate
